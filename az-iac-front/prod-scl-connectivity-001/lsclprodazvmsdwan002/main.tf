module "pip_sdwan_untrust" {
  ...
  name                    = "lsclprdazvmsdwan002-untrust"
...
module "lsclprdazvmsdwan002" {
  ...
  private_ip_address = {
    sdwan-untrust-ip1 = "10.99.41.5"
	  sdwan-trust-ip1   = "10.99.41.21"
    sdwan-ha-ip1      = "10.99.41.37"
    sdwan-mgmt-ip1    = "10.99.41.53"
  }

  # PIP para NIC untrust
  ...
  computer_name                   = "lsclprdazvmsdwan002"
